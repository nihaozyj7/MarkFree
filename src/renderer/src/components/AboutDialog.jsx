    ...
    <div className={`settings-overlay${open ? ' open' : ''}${closing ? ' closing' : ''}`} onClick={startClose}>
      <div className={`settings-dialog about-dialog${open ? ' open' : ''}${closing ? ' closing' : ''}`} onClick={e => e.stopPropagation()}>
        ...
        <div className="settings-body about-body">
          ...
          <h2 className="about-app-name">MarkdownPad</h2>
          <p className="about-version">版本 1.1.0</p>
          ...
          <a className="about-link" href="https://github.com/nihaozyj7/MarkdownPad" onClick={e => {
            e.preventDefault()
            window.open('https://github.com/nihaozyj7/MarkdownPad', '_blank')
          }}>
          ...
          <p className="about-copyright">© 2026 MarkdownPad</p>
        </div>
      </div>
    </div>
  )
